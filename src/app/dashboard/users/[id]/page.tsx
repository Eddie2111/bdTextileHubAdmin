        ...
        <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <p className="text-base">
                      {oneUserProfile.phoneNumber || "Not provided"}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base mt-1">
                    {oneUserProfile.address || "Not provided"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base mt-1">
                    {formatDate(oneUserProfile.createdAt)}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Orders, wishlists, and cart items
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="rounded-lg border p-4 flex flex-col items-center">
                  ...
                  <p className="text-2xl font-bold">
                    {oneUserProfile.wishlists.length}
                  </p>
                </div>
                <div className="rounded-lg border p-4 flex flex-col items-center">
              ...
              <Tabs defaultValue="orders">
                ...
                <TabsContent value="wishlist" className="space-y-4">
                  {oneUserProfile.wishlists.length > 0 &&
                  oneUserProfile.wishlists[0].products.length > 0 ? (
                    oneUserProfile.wishlists[0].products.map(
                      (product, index) => (
                        <div
                          key={index}
                          className="flex items-center justify-between rounded-lg border p-4"
                ...
                <TabsContent value="cart" className="space-y-4">
                  {oneUserProfile.carts.length > 0 &&
                  oneUserProfile.carts[0].products.length > 0 ? (
